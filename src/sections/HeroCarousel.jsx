...
const SLIDES = [
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=1600&q=80',
    tag: 'Repuestos Automotrices',
    title: 'Kits de Tiempo & Repuestos',
    highlight: 'Originales Garantizados',
    description: 'Encuentra kits de tiempo, correas, frenos, componentes de motor y suspensión de alta calidad para todas las marcas y modelos.',
  ...
  },
  {
    ...
    fallback: 'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&w=1600&q=80',
    tag: 'Lubricantes & Aditivos',
    title: 'Aceites de Motor Sintéticos',
    highlight: '& Filtros de Alto Rendimiento',
    description: 'Protección máxima para tu motor con la más amplia gama de lubricantes sintéticos, minerales, aceites de transmisión y filtros.',
    buttonText: 'Explorar Lubricantes',
    buttonLink: '#catalogo'
  },
  {
    id: 3,
    image: '/images/hero/slide3.png',
    fallback: 'https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?auto=format&fit=crop&w=1600&q=80',
    tag: 'Compatibilidad Garantizada',
    title: 'Tu Tienda de Repuestos',
    highlight: '& Asesoría Técnica',
    description: 'Búsqueda inteligente por marca, modelo y año. Insumos automotrices de primera con asesoría técnica especializada.',

  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      <div className="relative mb-6">
        <div className="absolute inset-0 rounded-full bg-primary-light/60 blur-2xl scale-150" />
        <div className="relative w-20 h-20 rounded-2xl bg-white border border-primary-light shadow-sm flex items-center justify-center">
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-primary-light text-primary text-sm font-medium hover:bg-primary-light/50 transition-all duration-200 active:scale-95"
        >

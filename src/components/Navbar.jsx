...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {exchangeRate && (
        <div className="w-full bg-rose-500 text-white text-xs text-center py-1.5 px-6 tracking-wide font-medium">
          💱 Tasa del día:{" "}
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-rose-100 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <a
            href="#inicio"
            className="flex items-center gap-2 text-2xl font-serif font-semibold text-rose-500 tracking-tight"
          >
            {store?.logo_url ? (
              <img
                src={store.logo_url}
